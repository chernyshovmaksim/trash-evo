...
<header class="header">
    <div class="container header__wrapper">
        <div class="header__logo">
            <a href="/">
                <img class="lazy" width="50px" height="50px" data-src="{{ \Helper::phpThumb('/theme/img/logo.webp', 'w=50,h=50,webp=1') }}" alt="Вывоз мусора Новосибирск">
            </a>
        </div>
        ...
        <div class="header__contacts contacts">
            <div class="contacts__icon">
                <a href="#">
                    <img class="lazy" width="28px" height="28px" data-src="{{ \Helper::phpThumb('/theme/img/phone-call.webp', 'webp=1,w=28,h=28') }}" alt="call">
                </a>
            </div>
        ...
        <div class="hero__content">
            <div class="hero__slider slider">
                <div class="slider__item">
                    <img class="lazy" data-src="/theme/img/tyuning-zil-samosval-foto-7.webp" alt="">
                    <div class="slider__overlay"></div>
                    <div class="slider__title">Самосвалы ЗИЛ</div>
                    <div class="slider__subtitle">Грузоподьемностью до 5т.</div>
                </div>
                <div class="slider__item">
                    <img class="lazy" data-src="/theme/img/tyuning-zil-samosval-foto-7.webp" alt="">
                    <div class="slider__overlay"></div>
            ...
            <div class="trash__services services">
                <div class="services__item">
                    <div class="services__image">
                        <img class="lazy" data-src="/theme/img/doorway_.webp" alt="">
                    </div>
                    <div class="services__title header-3">Строительный мусор</div>
                </div>
                <div class="services__item">
                    <div class="services__image">
                        <img class="lazy" data-src="/theme/img/doorway_.webp" alt="">
...
<footer class="footer">
    <div class="container">
        <div class="footer__logo">
            <img class="lazy" data-src="/theme/img/logo.webp" alt="">
            <span>
...
<div class="popup">
    <form>
        ...
        <input class="popup__tel" type="tel" name="phone" placeholder="Ваш телефон +7(000)000-00-00" required>
